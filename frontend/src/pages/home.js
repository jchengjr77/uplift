...
function Home(props) {
    ...
    async function getRandomFriend() {
        try {
            const response = await fetch(
                `/api/random-friend?self_id=${auth.currentUser.uid}`
            ).then((res) => res.json());
    ...
    async function getRandomMessage() {
        try {
            const response = await fetch(
                `/api/random-message?self_id=${auth.currentUser.uid}`
            );
                        ...
                        <ResponsiveButton
                            ...
                            onClick={
                                props.isAuthed
                                    ...
                                    : () => {
                                          alert(
                                              'Login to hear what others love about you!'
                                          );
                                      }
                            }
                        />
